...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
    ...
    <h1 class="font-serif text-4xl text-smoked-black mb-6">Vă Mulțumim pentru Comandă!</h1>

    <div class="w-16 h-px bg-vintage-gold mx-auto mb-8"></div>

    <p class="text-smoked-black/60 font-light max-w-xl mx-auto mb-12 leading-relaxed">
    ...
    <a href="{{ route('shop.index') }}" class="inline-block bg-smoked-black text-white px-10 py-5 uppercase tracking-[0.2em] text-[10px] font-medium hover:bg-vintage-gold transition-colors duration-500 shadow-sm">
        Înapoi la Galerie
    </a>
</div>
@endsection
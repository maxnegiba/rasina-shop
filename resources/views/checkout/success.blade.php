...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
    ...
    <h1 class="font-serif text-4xl text-dark-brown mb-6">
        {{ $order?->payment_status === 'paid' ? 'Vă Mulțumim pentru Comandă!' : 'Verificăm Plata' }}
    </h1>
    ...
    <p class="text-dark-brown/60 font-light max-w-xl mx-auto mb-12 leading-relaxed">
        @if($order?->payment_status === 'paid')
            Plata a fost confirmată. V-am trimis detaliile comenzii și documentul proforma la adresa de email introdusă în Stripe.
            Pregătim cu mare grijă piesele dumneavoastră.
        @else
            Confirmarea plății poate dura câteva momente. Nu repetați plata. Dacă nu primiți emailul de confirmare, contactați-ne și menționați sesiunea de plată.
        @endif
    </p>

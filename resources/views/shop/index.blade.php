            ...
            <div class="w-full md:w-3/4">
                ...
                @else
                    <div class="text-center py-32 bg-white ring-1 ring-inset ring-black/5 shadow-sm">
                        ...
                        <p class="font-light text-dark-brown/60 mb-10 text-sm max-w-md mx-auto leading-relaxed">Nu am găsit lucrări publicate în această secțiune. Vă invităm să explorați restul galeriei noastre.</p>

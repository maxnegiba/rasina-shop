...
<div class="bg-ivory py-16 sm:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl sm:text-5xl font-serif text-smoked-black mb-6">Ne Găsiți Aici</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div class="space-y-12">
                <div class="space-y-6">
                    <p class="text-smoked-black/80 font-light leading-relaxed">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        ...
                        <p class="font-serif text-smoked-black text-lg">
                            Strada Pasiunii, Nr. 10<br>
                            București, România
                        </p>
                        <p class="text-sm text-smoked-black/60 italic">(Vizite doar cu programare prealabilă)</p>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <ul class="font-light text-smoked-black/80 space-y-1 text-sm">
                ...
                <div class="p-6 bg-warm-beige/30 border border-vintage-gold/20 rounded-sm">
                    <h3 class="font-serif text-xl text-smoked-black mb-2">Comenzi Unicat</h3>
                    <p class="text-sm text-smoked-black/80 mb-4 font-light">Ai o idee specifică? Dorești un blat din rășină cu dimensiuni sau culori particulare?</p>
                    <a href="#cerere-personalizata" class="inline-block px-6 py-2 border border-smoked-black text-xs uppercase tracking-[0.15em] text-smoked-black hover:bg-smoked-black hover:text-white transition-all duration-300">
            ...
            <div class="bg-ivory p-8 sm:p-10 shadow-sm border border-black/5 rounded-sm relative">
                ...
                <h3 class="font-serif text-2xl text-smoked-black mb-8 relative z-10">Lăsați-ne un mesaj</h3>
                ...
                <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6 relative z-10">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label for="name" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Nume Complet <span class="text-vintage-gold">*</span></label>
                            <input type="text" name="name" id="name" required class="w-full bg-transparent border-b border-black/20 pb-2 focus:border-vintage-gold focus:outline-none transition-colors rounded-none font-light placeholder-black/30 text-smoked-black" placeholder="Ion Popescu">
                            @error('name') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <div class="space-y-2">
                            <label for="email" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Adresa de Email <span class="text-vintage-gold">*</span></label>
                            <input type="email" name="email" id="email" required class="w-full bg-transparent border-b border-black/20 pb-2 focus:border-vintage-gold focus:outline-none transition-colors rounded-none font-light placeholder-black/30 text-smoked-black" placeholder="ion@exemplu.ro">
                            @error('email') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                    </div>

                    <div class="space-y-2">
                        <label for="subject" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Subiect</label>
                        <input type="text" name="subject" id="subject" class="w-full bg-transparent border-b border-black/20 pb-2 focus:border-vintage-gold focus:outline-none transition-colors rounded-none font-light placeholder-black/30 text-smoked-black" placeholder="Întrebare despre un produs existent">
                        @error('subject') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>

                    <div class="space-y-2">
                        <label for="message" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Mesajul Dumneavoastră <span class="text-vintage-gold">*</span></label>
                        <textarea name="message" id="message" rows="4" required class="w-full bg-transparent border-b border-black/20 pb-2 focus:border-vintage-gold focus:outline-none transition-colors rounded-none font-light placeholder-black/30 text-smoked-black resize-none" placeholder="Cum vă putem ajuta?"></textarea>
                        @error('message') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>

                    <button type="submit" class="w-full bg-smoked-black text-white text-xs tracking-[0.2em] uppercase py-4 hover:bg-vintage-gold transition-colors duration-300 font-medium">
                        Trimite Mesajul
                    </button>

                    <p class="text-xs text-center text-smoked-black/50 font-light mt-4">
        ...
        <div id="cerere-personalizata" class="mt-24 border-t border-black/10 pt-24 pb-12">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-3xl font-serif text-smoked-black mb-6">Formular pentru Comenzi Personalizate</h2>
                <p class="text-smoked-black/80 font-light mb-10">
                ...
                <form action="{{ route('custom-request.store') }}" method="POST" class="space-y-6 text-left bg-ivory p-8 border border-vintage-gold/20 shadow-sm rounded-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label for="custom_name" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Nume Complet</label>
                        ...
                        <div class="space-y-2">
                            <label for="custom_email" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Email</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label for="custom_phone" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Telefon</label>
                        ...
                        <div class="space-y-2">
                            <label for="custom_dimensions" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Dimensiuni Dorite</label>
                    ...
                    <div class="space-y-2">
                        <label for="custom_colors" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Preferințe Culori / Rășină</label>
                    ...
                    <div class="space-y-2">
                        <label for="custom_details" class="block text-xs font-sans tracking-wider text-smoked-black/80 uppercase">Mesaj Special / Alte Detalii</label>
                    ...
                    <button type="submit" class="w-full bg-vintage-gold text-white text-xs tracking-[0.2em] uppercase py-4 hover:bg-smoked-black transition-colors duration-300 font-medium">

<div class="my-24 relative overflow-hidden bg-dark-brown text-ivory py-20 px-6 sm:px-12 lg:px-24">
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button type="button" x-data @click="$dispatch('open-custom-modal')" class="w-full sm:w-auto bg-vintage-gold text-white px-10 py-5 uppercase tracking-[0.2em] text-[10px] font-medium hover:bg-white hover:text-dark-brown transition-colors duration-500 shadow-lg">
                Solicită Proiect
            </button>
            ...
            @if($whatsappNumber)
                <a href="{{ $whatsappUrl }}" target="_blank" rel="noopener noreferrer" class="w-full sm:w-auto bg-transparent border border-vintage-gold text-vintage-gold px-10 py-5 uppercase tracking-[0.2em] text-[10px] font-medium hover:bg-vintage-gold hover:text-white transition-colors duration-500 flex items-center justify-center gap-3">

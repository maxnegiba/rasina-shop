<div class="flex flex-col h-full bg-ivory">
    ...
    <div class="flex-grow py-6 px-4 sm:px-6 overflow-y-auto" id="cart-items-container">
                ...
                @foreach($cart as $id => $details)
                    <div class="flex gap-4 items-center bg-ivory p-3 border border-black/5 relative group">
                        ...
                        <div class="flex-grow pr-6">
                            <h3 class="font-serif text-sm text-dark-brown mb-1 line-clamp-1" title="{{ $details['name'] }}">{{ $details['name'] }}</h3>
                            <p class="text-[10px] font-sans uppercase tracking-[0.1em] text-dark-brown/50 mb-2">
                                Cantitate: {{ $details['quantity'] }}
                            </p>
                            <p class="text-xs font-sans font-medium text-dark-brown tracking-wide">
        ...
        @else
            <div class="h-full flex flex-col items-center justify-center text-center py-12">
                ...
                <h3 class="font-serif text-lg mb-2 text-dark-brown">Colecția ta este goală</h3>
                <p class="font-light text-dark-brown/50 text-xs max-w-[200px] mx-auto">Nu ai adăugat încă nicio piesă în colecție.</p>
            </div>
        @endif
    </div>
    ...
    <div class="p-6 border-t border-black/5 bg-ivory">
        <div class="flex justify-between items-end mb-6">
            ...
            <span class="font-sans text-lg text-dark-brown tracking-wide font-medium" id="cart-sidebar-total">
